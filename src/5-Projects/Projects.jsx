        ...
        <p className="text-center mb-5 team-p">
          ...
          <h3 className="section-heading text-center mt-2 mb-4">Intro Workshops</h3>
            <ProjectCard
              ...
              image="public\static\project\Intro to arduino_ projects.png" 
            />
            <ProjectCard
              ...
              image="public\static\project\Introduction to Computer Science.png" 
            />
            <ProjectCard
              name="Intro to Java"
              link="https://docs.google.com/presentation/d/1mkV-e8Umj3ohlOdyqsSIXpQAvhg5J3osSbl5Z_efK3c/edit#slide=id.p"
              image="public\static\project\Intro to Java.png" 
            />
            <ProjectCard
            ...
            <ProjectCard
              ...
              image="public\static\project\Web Development Presentation.png" 
            />
            ...
            <ProjectCard
              ...
              image="public\static\project\Citrus Hack 2019 Opening Ceremony.png" 
            />
           <ProjectCard
              name="Mt. Hacks 2019"
              link="https://docs.google.com/presentation/d/16CZ6Xkcd68mVwhtWgw9XtgK--Ar2U6PZ1aphV6WcviA/edit#slide=id.p"
              image="public\static\project\Mt. Hacks Opening Ceremony.png" 
            />
            ...
            <ProjectCard
              ...
              image="public\static\project\Resume Workshop Slideshow.png" 
            />
            <ProjectCard
              ...
              image="public\static\project\MLH Localhost - No-Code App Building with Mendix - Workshop Slides With Video (v0.0.1).png" 
            />
            <ProjectCard
              name="AI Briefing"
              link="https://docs.google.com/presentation/d/19D-eFgYFcaV79_DuUVP9HVPauB9pX6LQ6jmz-KFvQpE/edit#slide=id.g2629d10e862_0_79"
              image="public\static\project\AI.png" 
            />
            <ProjectCard
